...
--[==[ return {
	...
	config = function()
        ...
        local function folder_icon()
            local icon, _ = devicons.get_icon("folder", { default = true })
            return icon or "" -- icono por defecto si no hay
        end
        ...
        lualine.setup({
            options = {
                ...
                icons_enabled = true,
                disabled_filetypes = {
                    statusline = { 'NvimTree' }, -- dont show statusline on the NvimTree window
                    winbar = {},
                },
            },
            sections = {
